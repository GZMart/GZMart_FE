...
export const landedCostService = {
  ...
  calculateLandedCost: async (calculationData) =>
    api.post(`${BASE_URL}/calculate`, calculationData),
   ...
   */
  saveCalculation: async (calculationData) => api.post(`${BASE_URL}/save`, calculationData),
   ...
   */
  getCalculationHistory: async (params = {}) => api.get(`${BASE_URL}/history`, { params }),
   ...
   */
  getCalculationById: async (id) => api.get(`${BASE_URL}/${id}`),
   ...
   */
  getDutyRates: async (params) => api.get(`${BASE_URL}/duty-rates`, { params }),
   ...
   */
  getShippingRates: async (params) => api.get(`${BASE_URL}/shipping-rates`, { params }),
   ...
   */
  getTaxRates: async (countryCode) => api.get(`${BASE_URL}/tax-rates/${countryCode}`),
   ...
   */
  getExchangeRates: async (params = {}) => api.get(`${BASE_URL}/exchange-rates`, { params }),
   ...
   */
  updateCalculation: async (id, calculationData) => api.put(`${BASE_URL}/${id}`, calculationData),
   ...
   */
  deleteCalculation: async (id) => api.delete(`${BASE_URL}/${id}`),
  ...
  exportToPDF: async (id) =>
    api.get(`${BASE_URL}/${id}/export/pdf`, {
      responseType: 'blob',
    }),
   ...
   */
  getCostBreakdownSummary: async (params = {}) => api.get(`${BASE_URL}/summary`, { params }),
};
