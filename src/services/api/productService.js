...
export const productService = {
  ...
  getProductsByCategory: async (category, params = {}) => {
    return api.get(`${BASE_URL}/category/${category}`, { params });
  },
  ...
  getFeaturedProducts: async (limit = 10) => {
    return api.get(`${BASE_URL}/featured`, { params: { limit } });
  },
  ...
  getRelatedProducts: async (productId, limit = 6) => {
    return api.get(`${BASE_URL}/${productId}/related`, { params: { limit } });
  },
  ...
  updateProduct: async (id, productData) => {
    return api.put(`${BASE_URL}/${id}`, productData);
  },
  ...
  uploadImages: async (productId, formData) => {
    return api.post(`${BASE_URL}/${productId}/images`, formData, {
  ...
  getProductReviews: async (productId, params = {}) => {
    return api.get(`${BASE_URL}/${productId}/reviews`, { params });
  },
