...
export const purchaseOrderService = {
   ...
   */
  getPurchaseOrders: async (params = {}) => api.get(BASE_URL, { params }),
   ...
   */
  getPurchaseOrderById: async (id) => api.get(`${BASE_URL}/${id}`),
   ...
   */
  createPurchaseOrder: async (poData) => api.post(BASE_URL, poData),
   ...
   */
  updatePurchaseOrder: async (id, poData) => api.put(`${BASE_URL}/${id}`, poData),
   ...
   */
  deletePurchaseOrder: async (id) => api.delete(`${BASE_URL}/${id}`),
   ...
   */
  submitPurchaseOrder: async (id) => api.post(`${BASE_URL}/${id}/submit`),
  ...
  approvePurchaseOrder: async (id, approvalData = {}) =>
    api.post(`${BASE_URL}/${id}/approve`, approvalData),
  ...
  rejectPurchaseOrder: async (id, rejectionData) =>
    api.post(`${BASE_URL}/${id}/reject`, rejectionData),
   ...
   */
  markAsOrdered: async (id, orderData) => api.post(`${BASE_URL}/${id}/ordered`, orderData),
   ...
   */
  recordGoodsReceipt: async (id, receiptData) => api.post(`${BASE_URL}/${id}/receive`, receiptData),
   ...
   */
  closePurchaseOrder: async (id) => api.post(`${BASE_URL}/${id}/close`),
  ...
  cancelPurchaseOrder: async (id, cancellationData) =>
    api.post(`${BASE_URL}/${id}/cancel`, cancellationData),
   ...
   */
  getStatistics: async (params = {}) => api.get(`${BASE_URL}/statistics`, { params }),
   ...
   */
  completePurchaseOrder: async (id) => api.post(`${BASE_URL}/${id}/complete`),
   ...
   */
  calculateLandedCost: async (poData) => api.post(`${BASE_URL}/calculate`, poData),
   ...
   */
  getSuppliers: async (params = {}) => api.get(SUPPLIER_URL, { params }),
   ...
   */
  getSupplierById: async (id) => api.get(`${SUPPLIER_URL}/${id}`),
   ...
   */
  createSupplier: async (supplierData) => api.post(SUPPLIER_URL, supplierData),
   ...
   */
  updateSupplier: async (id, supplierData) => api.put(`${SUPPLIER_URL}/${id}`, supplierData),
   ...
   * @returns {Promise} Deletion response
   */
  deleteSupplier: async (id) => api.delete(`${SUPPLIER_URL}/${id}`),
  ...
  getSupplierPurchaseHistory: async (id, params = {}) =>
    api.get(`${SUPPLIER_URL}/${id}/purchase-history`, { params }),
};
