...
const RegisterPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // TODO: Implement register logic (call API to send OTP)
      ...
      <div className={styles.loginContainer}>
        ...
        <div className={styles.contentWrapper}>
          ...
          <div className={styles.welcomeContent}>
            ...
            <div className={styles.signupPrompt}>
              ...
              <Link to={PUBLIC_ROUTES.LOGIN} className={styles.signupLink}>Login</Link>
            </div>
          </div>
        </div>
        ...
        <div className={styles.rightSection}>
          ...
          <form onSubmit={handleSubmit} className={styles.loginForm}>
                ...
                >
                  {showPassword ? (
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M3 3L21 21M10.5 10.5C10.0353 10.9646 9.75 11.6022 9.75 12.3C9.75 13.6569 10.8431 14.75 12 14.75C12.6978 14.75 13.3354 14.4647 13.8 14M6.5 6.5C4.8 7.7 3 10 3 12C3 15 7.5 19 12 19C13.5 19 15 18.5 16.5 17.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                      <path d="M12 5C16.5 5 21 8 21 12C21 13 20.5 14 19.5 15" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                    </svg>
                  ) : (
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <button type="button" className={styles.socialButtonFacebook} onClick={handleFacebookSignup}>
