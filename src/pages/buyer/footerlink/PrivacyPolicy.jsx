...
const contactDetails = {
  email: 'united deals.contact@gmail.com',
  companyName: 'United deals',
  address: [
    'A-3/B, S.G. Towers, Bhiringi Mondal Para,',
...
const privacyData = [
  ...
  },
  {
    title: 'Contact',
    content: [
      'Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, email us at united deals.contact@gmail.com or contact us at A-3/B, S.G. Towers, Bhiringi Mondal Para, Benachity, Durgapur, Paschim Bardhaman,West Bengal,India-713213.',
    ],
  },
];
...
const PrivacyPolicy = () => {
  ...
  return (
    // Responsive Padding: py-4 on mobile, py-md-5 on desktop
    <div className="container py-4 py-md-5">
      {/* --- HEADER --- */}
      {/* Padding x-3 for mobile edge spacing, 0 on desktop since container handles it */}
      ...
      <div className="pb-5 mx-md-4 px-3 px-md-0">
        {/* Responsive Heading: fs-1 (smaller) on mobile, display-4 on desktop */}
        <h1 className="fs-1 display-md-4 fw-bolder mb-4 text-dark">Privacy Policy</h1>
          ...
          {privacyData.map((section, index) => (
            <div key={index} className="mb-5">
              ...
              {section.content.map((paragraph, pIndex) => (
                <p
                  key={pIndex}
                  // Logic: Reduce margin if paragraph starts with a bullet point to keep list tight
                  className={paragraph.startsWith('•') ? 'mb-2' : 'mb-3'}
                >
                  {/* Link detection helper */}
                  {paragraph.split(' ').map((word, wIdx) => {
                    if (word.includes('https://') || word.includes('http://')) {
                      // Clean punctuation from URL
