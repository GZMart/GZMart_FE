    ...
    <div className={styles.container}>
      ...
      <div className={styles.tableWrap}>
        <table className={styles.table}>
          <thead>
            <tr>
              <SortableHeader label="Supplier"    colKey="name"             sortKey={sortKey} sortDir={sortDir} onSort={handleSort} />
              <SortableHeader label="Contact"     colKey="contactPerson"    sortKey={sortKey} sortDir={sortDir} onSort={handleSort} />
              <SortableHeader label="Reliability" colKey="reliabilityScore" sortKey={sortKey} sortDir={sortDir} onSort={handleSort} align="center" />
              <SortableHeader label="Status"      colKey="status"           sortKey={sortKey} sortDir={sortDir} onSort={handleSort} align="center" />
              <SortableHeader label="Orders"      colKey="totalOrders"      sortKey={sortKey} sortDir={sortDir} onSort={handleSort} align="center" />
              <th>Actions</th>
            </tr>
          </thead>
          <tbody>
              ...
              <tr key={supplier._id}>
                ...
                <td>
                  <div className={styles.supplierCell}>
                    ...
                    <div>
                      <Link to={`/seller/erp/suppliers/${supplier._id}`} className={styles.supplierLink}>
                        {supplier.name}
                      </Link>
                      {supplier.address && (
                ...
                <td>
                  <div className={styles.rowActions}>
                    <Link to={`/seller/erp/suppliers/${supplier._id}`} className={`${styles.actionBtn} ${styles.btnView}`}>
                      <IconEye /> View
                    </Link>
                    <button
