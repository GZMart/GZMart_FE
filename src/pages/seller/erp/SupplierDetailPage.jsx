...
import SupplierDrawer from '@components/seller/erp/SupplierDrawer';
import styles from '@assets/styles/seller/erp/SupplierDetailPage.module.css';
import {
  ArrowLeft,
  PencilLine,
  User,
        ...
        <div className={styles.infoCard}>
          ...
          <div className={styles.infoGrid}>
            <InfoItem
              ...
              value={contact.contactPerson || supplier?.contactPerson}
            />
          ...
          <div className={styles.infoGrid}>
            <InfoItem
              icon={FileText}
              label="Tax Code"
              value={billingInfo.taxCode || supplier?.taxCode}
            />
            <InfoItem
              icon={Building2}
              label="Bank Name"
              value={billingInfo.bankName || supplier?.bankName}
            />
            ...
            <InfoItem
              ...
              value={billingInfo.defaultCurrency}
            />
            <InfoItem
              icon={Clock}
              label="Payment Terms"
              value={billingInfo.paymentTerms || supplier?.paymentTerms}
            />
          </div>
