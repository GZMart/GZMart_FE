...
import { Camera, Save, User, MapPin, Loader2, Mail, Phone, Calendar, Shield, Store, ImagePlus, X } from 'lucide-react';
...
const SellerProfilePage = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (bannerFile) submitData.append('profileImage', bannerFile);
            ...
            <div className={styles.layout}>
                ...
                <main className={styles.mainContent}>
                    ...
                    <section className={styles.card}>
                        ...
                        <p className={styles.sectionHint}>This banner and description will be displayed when buyers visit your shop page.</p>
                            ...
                            {bannerPreview ? (
                                <div className={styles.bannerPreviewWrapper}>
                                    ...
                                    <div className={styles.bannerActions}>
                                        <button type="button" className={styles.bannerChangeBtn} onClick={handleBannerClick}>
                                            <Camera size={16} /> Change
                                        </button>
                                        <button type="button" className={styles.bannerRemoveBtn} onClick={handleRemoveBanner}>
                                            <X size={16} /> Remove
                                        </button>
                                    </div>
                                </div>
