...
const termsData = [
  ...
  },
  {
    ...
    content: [
      ...
      'For more details, please review our Refund Policy: https://uniteddeals.tech/policies/refund-policy',
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      'Your submission of personal information through the store is governed by our Privacy Policy, which can be viewed here: https://uniteddeals.tech/policies/privacy-policy',
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      'In no case shall United deals, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, Service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the Service or any products procured using the Service, or for any other claim related in any way to your use of the Service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the Service or any content (or product) posted, transmitted, or otherwise made available via the Service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.',
    ],
  },
  {
    title: 'SECTION 14 - INDEMNIFICATION',
    content: [
      'You agree to indemnify, defend and hold harmless United deals and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, Service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.',
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      'Questions about the Terms of Service should be sent to us at united deals.contact@gmail.com.',
      'Our contact information is posted below:',
      'United deals',
      'united deals.contact@gmail.com',
      'A-3/B, S.G. Towers, Bhiringi Mondal Para, Benachity, Durgapur, Paschim Bardhaman,West Bengal,India-713213.',
      '+91 7319265132',
    ],
  },
];
...
const TermsOfService = () => {
  ...
  return (
    <div className="container">
      <div className="d-flex align-items-center justify-content-between mb-3 mx-md-4">
        <div
        ...
        >
          <div
            ...
            style={{ width: '45px', height: '45px', borderColor: '#E5E7EB' }}
          >
      ...
      <div className="pb-5 mx-md-4">
        <h1 className="display-4 fw-bolder mb-4 text-dark">Terms of Service</h1>

        <div className="text-secondary" style={{ fontSize: '1rem', lineHeight: '1.7' }}>
          {termsData.map((section, index) => (
            <div key={index} className="mb-5">
              <h6 className="text-uppercase fw-bold text-dark">{section.title}</h6>
              {section.content.map((paragraph, pIndex) => (
                <p key={pIndex} className={section.title === 'Overview' ? 'mb-3' : 'mb-0'}>
                  {paragraph}
                </p>
              ))}
            </div>
