    ...
    return (
        <Container fluid className="p-4" style={{ backgroundColor: '#F8FAFC', minHeight: '100vh', fontFamily: "'Fira Sans', sans-serif" }}>
            ...
            <div className="d-flex justify-content-between align-items-center mb-5">
                <div>
                    <h2 className="mb-0 fs-3" style={styles.pageHeader}>System Vouchers</h2>
                    <p className="text-secondary mb-0 mt-1" style={{ fontSize: '0.95rem' }}>Global discount management & analytics</p>
                </div>
                <Button
                    as={Link}
                ...
                <Table hover responsive className="align-middle mb-0" style={{ fontSize: '0.95rem' }}>
                    ...
                    <tbody>
                        {loading ? (
                            ...
                            <tr><td colSpan="7" className="text-center py-4">No vouchers found.</td></tr>
                        ) : (
                                ...
                                <tr key={voucher._id} style={{ borderBottom: '1px solid #F1F5F9' }}>
                                    ...
                                    <td>
                                        {voucher.type === 'system_shipping' ? (
                                            <Badge style={styles.badgeShipping} className="rounded-pill px-3 py-2 fw-normal">Free Ship</Badge>
                                        ) : (
                                            <Badge style={styles.badgeOrder} className="rounded-pill px-3 py-2 fw-normal">Discount</Badge>
                                        )}
                                    </td>
                                    <td>
                                    ...
                                    <td style={{ minWidth: '150px' }}>
                                        <div className="d-flex justify-content-between mb-1" style={{ fontSize: '0.8rem' }}>
                                            ...
                                            <span className="fw-semibold">{voucher.usageCount || 0} / {voucher.usageLimit}</span>
                                        </div>
                                    ...
                                    <td>
                                        <Badge style={voucher.status === 'active' ? styles.badgeActive : {}} bg={voucher.status === 'active' ? null : 'secondary'} className="rounded-pill px-3">
                                            {voucher.status}
                                        </Badge>
                                    </td>
                                    <td>
