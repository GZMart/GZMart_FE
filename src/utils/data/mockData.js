...
const createProduct = (
  ...
  const result = generateInventoryAndVariants(
    productType,
    baseSku,
    sizes,
    colors,
  ...
  createProduct(
    {
      ...
      description:
        'Premium running shoes with responsive Boost cushioning. Long distance running requires a lot from athletes.',
      brand: 'Adidas',
  ...
  createProduct(
    {
      ...
      description:
        'The Nike Air Max 270 features a large window and visible air unit for maximum cushioning. Delivers visible cushioning under every step.',
      brand: 'Nike',
      category: '507f1f77bcf86cd799439012',
      productType: 'shoes',
      sku: 'NK-AM270-001',
  ...
  createProduct(
    {
      ...
      description:
        'The Puma RS-X combines retro style with modern comfort. Retro-inspired design with modern technology.',
      brand: 'Puma',
      category: '507f1f77bcf86cd799439012',
      productType: 'shoes',
      sku: 'PM-RSX-001',
  ...
  createProduct(
    {
      ...
      description:
        'The New Balance 574 combines timeless style with contemporary comfort. Classic New Balance design with modern comfort.',
      brand: 'New Balance',
      category: '507f1f77bcf86cd799439012',
      productType: 'shoes',
      sku: 'NB-574-001',
  ...
  createProduct(
    {
      ...
      description:
        'The Reebok Classic Leather features premium leather construction. Timeless leather sneaker with classic design.',
      brand: 'Reebok',
      category: '507f1f77bcf86cd799439012',
      productType: 'shoes',
      sku: 'RB-CL-001',
  ...
  createProduct(
    {
      ...
      description:
        'The Converse Chuck Taylor All Star is a timeless classic. The iconic canvas sneaker that never goes out of style.',
      brand: 'Converse',
      category: '507f1f77bcf86cd799439012',
      productType: 'shoes',
      sku: 'CV-CT-001',
  ...
  createProduct(
    {
      ...
      description:
        'The Vans Old Skool features the iconic side stripe and durable canvas. Classic skate shoe with the iconic side stripe.',
      brand: 'Vans',
      category: '507f1f77bcf86cd799439012',
      productType: 'shoes',
      sku: 'VN-OS-001',
  ...
  createProduct(
    {
      ...
      description:
        'The Adidas Samba is a classic indoor soccer shoe. Iconic indoor soccer shoe with timeless style.',
      brand: 'Adidas',
      category: '507f1f77bcf86cd799439012',
      productType: 'shoes',
      sku: 'AD-SB-001',
  ...
  createProduct(
    {
      ...
      description:
        'The Air Jordan 1 is the shoe that started it all. The Air Jordan 1 revolutionized basketball footwear.',
      brand: 'Nike',
      category: '507f1f77bcf86cd799439012',
      productType: 'shoes',
      sku: 'NK-AJ1-001',
  ...
  createProduct(
    {
      ...
      description:
        'The Yeezy Boost 350 features a Primeknit upper. Revolutionary design meets comfort.',
      brand: 'Adidas',
      category: '507f1f77bcf86cd799439012',
      productType: 'shoes',
      sku: 'AD-YZ350-001',
