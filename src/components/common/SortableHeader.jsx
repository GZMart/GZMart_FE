 ...
 *   />
 */
const SortableHeader = ({ label, colKey, sortKey, sortDir, onSort, align = 'left', className = '' }) => {
...
const UpIcon   = () => <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="m18 15-6-6-6 6"/></svg>;
const DownIcon = () => <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="m6 9 6 6 6-6"/></svg>;
const BothIcon = () => <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="m18 15-6-6-6 6M6 9l6-6 6 6" opacity=".4"/><path d="m6 15 6 6 6-6" opacity=".4"/></svg>;
