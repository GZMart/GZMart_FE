...
import PropTypes from 'prop-types'; // Thêm thư viện validation
...
// Định nghĩa Card component riêng biệt để dễ quản lý PropTypes
...
// Khai báo PropTypes cho BrandBannerCard
BrandBannerCard.propTypes = {
