          ...
          <Form>
            <Form.Group className="mb-4">
              ...
              <Form.Text className="text-muted">
                Hệ thống sẽ tự động gửi tin nhắn mẫu khi Khách hàng mới bắt đầu chat hoặc gửi sản
                phẩm yêu cầu hỗ trợ.
              </Form.Text>
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Select
                ...
                onChange={(e) =>
                  setSettings({ ...settings, cooldownHours: parseInt(e.target.value) })
                }
                disabled={!settings.isEnabled}
              >
              ...
              <Form.Text className="text-muted">
                Để tránh spam, nếu khách tiếp tục nhắn tin trong thời gian chờ này, hệ thống sẽ
                KHÔNG tự động gửi lại tin nhắn mẫu nữa (trừ phi Shop đã chủ động phản hồi).
              </Form.Text>
            </Form.Group>
          </Form>
        )}
