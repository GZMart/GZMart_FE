...
import drawerStyles from '@assets/styles/seller/erp/EditPODrawer.module.css';
import formStyles from '@assets/styles/seller/erp/CreatePurchaseOrderPage.module.css';
import {
  TIER_TYPES,
  TIER_TYPE_KEYS,
  CUSTOM_OPTION,
          ...
          <div className={d.drawerHeaderLeft}>
            ...
            <div>
              ...
              <div className={d.drawerSubtitle}>
                ...
                <span>
                  · {isLocked ? 'Only Notes and Expected Date editable' : 'Draft: full edit'}{' '}
                </span>
              </div>
            </div>
          </div>
