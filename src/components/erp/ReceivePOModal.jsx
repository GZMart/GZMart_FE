...
import styles from './ReceivePOModal.module.css';
...
return;
    ...
    try {
      ...
      await dispatch(
        receivePurchaseOrder({ id, arrivalCostsPayload: payload })
      ).unwrap();
    ...
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <p className={styles.hint}>
          Enter actual costs when goods arrive at VN warehouse. System will calculate landed cost and update inventory.
        </p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={styles.actions}>
            ...
            <button
              ...
              disabled={submitting}
            >
              {submitting ? <Loader2 size={14} className={styles.spinIcon} /> : <Package size={14} />}
